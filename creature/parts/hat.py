...
from config.colors import CREATURE_HAT_STROKE
from config.defaults import DEBUG_MODE
from config.defaults import HAT_NAME
from config.defaults import LOG_CREATURE_BUILD
from config.sizes import HAT_BRIM_HEIGHT
from config.sizes import HAT_BRIM_WIDTH
from config.sizes import HAT_HEIGHT
from config.sizes import HAT_WIDTH

from core.anchors import get_hat_base_center
from core.geometry import point
from core.layout import place_below
