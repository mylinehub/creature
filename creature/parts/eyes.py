...
from config.colors import EYE_STROKE
from config.colors import EYE_WHITE
from config.colors import PUPIL_FILL
from config.colors import PUPIL_HIGHLIGHT
from config.defaults import DEBUG_MODE
from config.defaults import LEFT_EYE_NAME
from config.defaults import LOG_CREATURE_BUILD
from config.defaults import RIGHT_EYE_NAME
from config.sizes import EYE_HEIGHT
from config.sizes import EYE_STROKE_WIDTH
from config.sizes import EYE_WIDTH
from config.sizes import PUPIL_MAX_OFFSET
from config.sizes import PUPIL_RADIUS

from core.anchors import get_left_eye_center
from core.anchors import get_right_eye_center
