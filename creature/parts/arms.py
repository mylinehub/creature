...
from config.colors import CREATURE_ARM_COLOR
from config.defaults import DEBUG_MODE
from config.defaults import LEFT_ARM_NAME
from config.defaults import LOG_CREATURE_BUILD
from config.defaults import RIGHT_ARM_NAME
from config.sizes import ARM_LENGTH
from config.sizes import ARM_STROKE_WIDTH

from core.anchors import get_left_shoulder_anchor
from core.anchors import get_right_shoulder_anchor
