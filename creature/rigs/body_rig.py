...
from creature.rigs.arm_rig import build_arm_rig_map
from creature.rigs.face_rig import build_face_rig_map
from creature.rigs.leg_rig import build_leg_rig_map
