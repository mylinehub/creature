...
from mathlab_creature.config.colors import MATH_BOARD_FILL
from mathlab_creature.config.colors import MATH_BOARD_STROKE
from mathlab_creature.config.defaults import DEBUG_MODE
from mathlab_creature.config.defaults import LOG_CREATURE_BUILD
from mathlab_creature.config.sizes import MATH_BOARD_HEIGHT
from mathlab_creature.config.sizes import MATH_BOARD_WIDTH
