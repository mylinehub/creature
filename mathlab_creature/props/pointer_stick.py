...
from mathlab_creature.config.colors import POINTER_STICK_COLOR
from mathlab_creature.config.defaults import DEBUG_MODE
from mathlab_creature.config.defaults import LOG_CREATURE_BUILD
from mathlab_creature.config.sizes import POINTER_STICK_LENGTH
from mathlab_creature.config.sizes import POINTER_STICK_STROKE_WIDTH
